...
class Bird:
    # 构造函数
    def __init__(self, bird_x, bird_y, bird_radius, bird_movement=0, color=(0, 0, 255)):
        self.bird_x = bird_x
    ...
    def draw_self(self, pad):
        pygame.draw.circle(pad.screen, self.color, (self.bird_x, self.bird_y), self.bird_radius)
